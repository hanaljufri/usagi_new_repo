...
import org.ohdsi.usagi.dataImport.ImportData.ImportSettings;
...
//		}
	...
	private void recomputeScores(ScoreDoc[] scoreDocs, Query query) {
		try {
			Term2Tfidf searchTerm = null; //stuck here
	...
	public static class ScoredConcept {
		...
		public String toString() {
			return "Score: "+this.matchScore+" |Term: "+this.term+this.concept.toString();
		}
	}
